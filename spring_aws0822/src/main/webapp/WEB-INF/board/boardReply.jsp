...
<form name="frm">
 	<input type="hidden" value="<%=bv.getBidx()%>" name="bidx">
	<input type="hidden" value="<%=bv.getOriginbidx()%>" name="originbidx">
	<input type="hidden" value="<%=bv.getDepth()%>" name="depth">
	<input type="hidden" value="<%=bv.getLevel_()%>" name="level_">
